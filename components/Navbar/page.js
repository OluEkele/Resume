...
import './Navbar.css'
import logo from '@/public/access/Letter.png'
import { Link } from 'react-scroll';
import contact from '@/public/access/contact.webp'
...
const Navbar = () => {
  ...
  return (
    <nav className='navbar'>
        <Image width={100} height={100} src={logo} alt='' className='logo'/>
        ...
        <button className='desktopMenuBtn' onClick={()=>{
          document.getElementById('contact').scrollIntoView({behavior: 'smooth'});
            ...
            <Image width={100} height={100} src={contact} alt='' className='desktopMenuImg'/>
            Contact Me
        </button>
